...
$(document).ready(function() {
   ...
   var sparklineLogin = function() { 
        ...
        $("#sparkline11").sparkline([2,4,4,6,8,5,6,4,8,6,6,2], {
            ...
            maxSpotColor: '#818382',
            highlightLineColor: 'rgba(0, 0, 0, 0.2)',
            highlightSpotColor: '#818382'
        });
        
        $("#sparkline12").sparkline([2,4,4,6,8,5,6,4,8,6,6,2], {
            type: 'line',
            width: '100%',
            height: '50',
            lineColor: '#8218C6',
